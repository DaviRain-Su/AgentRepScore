...
echo ""
echo "Bootstrapping modules to Validator..."
$CAST send --private-key "$PRIVATE_KEY" --rpc-url "$RPC_URL" "$VALIDATOR" "bootstrapModules(address[],uint256[])" "[$UNI_MODULE,$BASE_MODULE]" "[4000,2500]"
